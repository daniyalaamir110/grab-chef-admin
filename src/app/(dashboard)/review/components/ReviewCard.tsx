...
const ReviewCard = ({
  ...
  return (
    <div className={`bg-white rounded-lg  ${isSelected ? 'border border-l-4 border-l-red-500 shadow-md shadow-red-300' : ''} p-4 hover:shadow-sm transition-shadow duration-200`}>
