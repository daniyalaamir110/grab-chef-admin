        ...
        <div className="relative bg-white rounded-lg">
          ...
          <div className="p-6 pb-4">
            <div className="flex items-start gap-4 mb-6">
              <img
            src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjKNpeICypw6HglgXH9dwb2Uj4rG0eH9DXcQ&s'}
                alt={chef.firstName}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className='shadow-lg p-2 rounded-lg'>
                ...
                <div className=" rounded-md py-2">
                  <span className="text-sm text-gray-900">{chef.firstName}</span>
                </div>
              </div>
              ...
              <div  className='shadow-lg p-2 rounded-lg'>
                ...
                <div className=" rounded-md py-2">
                  <span className="text-sm text-gray-900">{chef.phoneNumber}</span>
                </div>
              </div>
              ...
              <div  className='shadow-lg p-2 rounded-lg'>
                ...
                <div className=" rounded-md px-3 py-2">
                  <div className="flex gap-1">
                    {chef?.achievements?.map((achievement:any, index:number) => (
                      <div
                        key={index}
                      ...
                      >
                        {achievement === 'gold' ? '🥇' : achievement === 'silver' ? '🥈' : '🥉'}
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div  className='shadow-lg p-2 rounded-lg'>
                ...
                <div className=" rounded-md py-2 flex flex-wrap gap-1">
                  {chef?.location?.map((loc:string, index:number) => (
                    <span
                      key={index}
