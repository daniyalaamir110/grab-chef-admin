...
const AttendeePermissions: FC<PermissionProps> = ({
  formik,
  setOpenModal,
  setPermissionKey,
  type,
  ...
  return (
    <>
      {Object.entries(AccessControlConstants).map(([key, value]) => (
        <div
          key={key}
                          ...
                          setField={checked => {
                            {
                              ...
                              formik.setFieldValue(
                                `${type ?? value.key}.${ProjectPermissionEnum[field.title as keyof typeof ProjectPermissionEnum]}.value`,
                                checked ? formikValue?.value : 0,
                              );
                            }
                          }}
                        />
...
export default AttendeePermissions;
